...
The source code, validation programs, exact certificates, and data are
available under the [MIT License](LICENSE). The manuscript source,
bibliography, and rendered PDF in [`paper/`](paper/) are available under the
[Creative Commons Attribution 4.0 International License](paper/LICENSE).
